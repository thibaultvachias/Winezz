package com.orion.android.tabbar.produits;
...
public class Pivot_ActivityGroup_Produits extends ActivityGroup implements OnTouchListener
{
	/******************************************************************************************/
	/************************************** CONSTANTES ****************************************/
	/******************************************************************************************/
	 ...
	 * TAG
	 */
	private String TAG = "Pivot_ActivityGroup_ModrMprime";
...
//		if(A== null)
//		{
//			if(DEBUG) Log.i(TAG, "getParent is null");
//		}
//		else
//		{		
//			// Tab
...
//	        if(tabHost == null)
//	        {
//	        	if(DEBUG) Log.i(TAG, "tabhost = null");
//	        }
//	        else
//	        {
//	        	View childTab = tabHost.getTabWidget().getChildTabViewAt(TabActivity_OffersUniverse.ID_TAG_OFFERS);
//	        	if(childTab == null)
//	        	{
//	        		if(DEBUG) Log.i(TAG, "childTab = null");
//	        	}
//	        	else
//	        	{
//	        		childTab.setOnTouchListener(Pivot_ActivityGroup_Produits.this);
//	        	}
//	        }
//		}
	}
...
//		if(ActivityCode.ACTIVITY_OFFERS_LIST.equals(currentActivity))
//		{
//			getParent().onBackPressed();
//		}
...
//		if(ActivityCode.ACTIVITY_OFFERS_LIST.equals(requestCode))
//		{
